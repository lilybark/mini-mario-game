...
#ifndef MINI_MARIO_KEYBOARD_H
#define MINI_MARIO_KEYBOARD_H
...
namespace MiniMario {
    ...
    public:
        ...
        enum Key {
            // these were taken straight from glfw3.h, and are compatible with GLFW keyboard function calls.
            SPACE             = 32,
            APOSTROPHE        = 39,
            COMMA             = 44,
            MINUS             = 45,
    ...
    private:
        ...
        static Keyboard *_inst;
    };

} // MiniMario

#endif //MINI_MARIO_KEYBOARD_H
